...
```
>Note: If you're interested in the AURORA package, the [Brain Metastases Segmentation]( https://github.com/BrainLesion/BraTS?tab=readme-ov-file#brain-metastases-segmentation) may also be of interest.
